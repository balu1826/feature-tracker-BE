...
public class ApplicantProfileService {
	...
	public ApplicantProfileService(ApplicantProfileRepository applicantProfileRepository,
			RegisterRepository applicantService,ApplicantEducationRepository  applicantEducationRepository) {
	...
	public String createOrUpdateApplicantProfile(long applicantId, ApplicantProfileDTO applicantProfileDTO)
		...
		if (applicant == null)
			...
			if (existingProfile == null) {
	            ...
	            createEducationFromProfile(applicant, applicantProfile);
...
//	        	    applicantSkillBadgeRepository.deleteByApplicantIdAndSkillBadgeId(applicantId, skillBadge.getId());
	...
	private void createEducationFromProfile(Applicant applicant, ApplicantProfile applicantProfile) {

	    try {
	        ApplicantEducation applicantEducation = new ApplicantEducation();
	        applicantEducation.setApplicant(applicant);
	        applicantEducation.setGradDegree(applicantProfile.getQualification());
	        applicantEducation.setGradSpecialization(applicantProfile.getSpecialization());

	        applicantEducationRepository.save(applicantEducation);

	    } catch (Exception e) {
	        throw new CustomException(
	                "Failed to save education details: " + e.getMessage(),
	                HttpStatus.INTERNAL_SERVER_ERROR
	        );
	    }
	}
